 ...
 * immediately in {android.app.Activity#onPause()} (and re-{@link #open()}
...
public class BarCodeReader {
    ...
    private native void native_autoFocus();
    private native void native_cancelAutoFocus();
    private native String native_getParameters();
    private native void native_release();
    private native int setNumParameter(int paramNum, int paramVal);
    private native int setStrParameter(int paramNum, String paramVal);
    private native void native_setParameters(String params);
    private native void native_setup(Object reader_this, int readerId);
    private native void native_setup(Object reader_this, int readerId, Object currentContext);
    private native void native_startPreview(int mode);
    private native void native_takePicture();
    private native void setHasPreviewCallback(boolean installed, boolean manualBuffer);
    private native void setPreviewDisplay(Surface surface);
     ...
     *
     * <p>{BarCodeReader.VideoCallback#onVideoFrame(format, width, height, byte[], BarCodeReader)}
     ...
     *             {#ParamVal.HANDSFREE} or {#ParamVal.AUTO_AIM}.
    ...
    public final void setPreviewDisplay(SurfaceHolder holder) throws IOException {
        if (holder != null) setPreviewDisplay(holder.getSurface());
        else setPreviewDisplay((Surface) null);
    }
     ...
     * {#Parameters.setFocusMode(String)} and {#setParameters(Parameters)}
     ...
     * mode is active (after calling {#startViewFinder()}).  Image capture
     * will be stopped after the picture taken callback is called.  Callers must
     * call {#startViewFiner()} and/or takePicture() again if they want to
     * re-start the view finder or take more pictures.
     *
     * <p>After calling this method, you must not call {@link #startPreview()},
     * {#startViewFinder()} or take another picture until the picture taken
            ...
            switch (msg.what) {
                ...
                case BCRDR_MSG_FOCUS:
                    if (mAutoFocusCallback != null) {
                        mAutoFocusCallback.onAutoFocus(msg.arg1 != 0, mReader);
                    }
                    return;
    ...
    public static class Parameters {
        ...
        public void setPreviewFormat(int pixel_format) {
            ...
            if (s == null) throw new IllegalArgumentException("Invalid pixel_format=" + pixel_format);
        ...
        private float getFloat() {
            ...
            try {
                ...
                flRetVal = Float.parseFloat(mMap.get(Parameters.KEY_EXPOSURE_COMPENSATION_STEP));
                return (flRetVal);
            } catch (Throwable thrw) {
                thrw.printStackTrace();
            }
